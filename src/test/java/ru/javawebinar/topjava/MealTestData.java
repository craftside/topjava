...
public class MealTestData {
    ...
    public static final Meal MEAL_6 = new Meal(MEAL_ID + 6, LocalDateTime.of(2015, 5, 31, 10, 0 ), "Завтрак админа всея руси",1000);
    public static final Meal MEAL_7 = new Meal(MEAL_ID + 7, LocalDateTime.of(2015, 5, 31, 13, 0 ), "Обед админа всея руси",500);
